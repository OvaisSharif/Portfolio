...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "7b48aa88-4848-45ee-a17f-7faefdd65bfe");
  ...
  return (
    ...
    bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none">
      <motion.h4
      ...
      <motion.form
       ...
       rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>Submit <Image src={assets.right_arrow_white} alt=''
