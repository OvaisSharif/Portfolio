...
const Works = () => {
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
        ...
        {workData.map((project, index) => (
          ...
          >
            ...
            py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
              ...
              <div className="border rounded-full border-gray-700 w-9 aspect-square flex items-center justify-center
      ...
      <a className="w-max flex items-center justify-center gap-2 text-gray-700
       border-[0.5px] border-gray-700 rounded-full px-10 py-3 mx-auto my-20 hover:bg-lightHover duration-500">
